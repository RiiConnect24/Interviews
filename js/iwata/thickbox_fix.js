...
//			alert(mv)
			...
			$("#TB_window").append("<div id='TB_header'><div id='TB_ajaxCaption'>"+caption+"</div><div id='TB_closeAjaxWindow'><a href='javascript:;' id='TB_closeWindowButton'><img src='images/b_close.gif' alt='CLOSE' width='11' height='11' border='0'></a></div><br clear='all'></div><div id='TB_ajaxContent' style='width:"+ajaxContentW+"px;height:"+ajaxContentH+"px;'></div>");
			$("#TB_closeWindowButton").click(TB_remove);
